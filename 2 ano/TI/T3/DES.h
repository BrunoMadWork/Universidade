...
#define MASCARA_28 268435455 //máscara com os 28 primeiros bits MENOS significativos a 1, os restantes a 0
...
int ordemV[16] = {1,1,2,2,2,2,2,2,1,2,2,2,2,2,2,1};
...
unsigned long long exchange(unsigned long long, unsigned int table[], int);
