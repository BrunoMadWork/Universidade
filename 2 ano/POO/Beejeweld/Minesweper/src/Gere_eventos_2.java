 ...
 */
public class Gere_eventos_2 implements ActionListener  {
   ...
   private Container c;
   public Gere_eventos_2(JFrame jan, Peças[][] pe, int l, int sc ,Peças i ,int r, int sp, Container co){
   ...
   public Peças [][] array_peças() {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(contar_marcadas()==2){
            System.out.println("Entrou na parte de se destruir");
       ...
       if(is_side_to_side_vertical(peça1,peça2)==true||is_side_to_side_horizontal(peça1,peça2)==true){
           ...
           if(peça1.n_peças_horizontal()>1&&alguma_lado_3()||peça1.n_peças_vertical()>1&&alguma_lado_3()||peça2.n_peças_vertical()>1&&alguma_lado_3()||peça2.n_peças_horizontal()>1&&alguma_lado_3()){
               System.out.println("viu que tem peças para se destruirem");
           ...
           print_pecas_lado();
            destruir();
            encher_tudo();
            System.out.println(" reencheu se");
           // desmarcar_tudo()
				...
				if(array_peças[0][j]==null){
                                             ...
                                             int especial=random_power(especial_percentagem);
                                              if(tipo==1){
                                                  ...
                                                  array_peças[0][j].addActionListener(new Gere_eventos_2(janela,array_peças,lado,score,array_peças[0][j],ronda,score_peça, c));
...
public void ver_peças_ao_lado_auxiliar() {
    ...
    public void destruir(){
     ...
     public Peças random_peça(){
        ...
        if(tipo==1){
           Peças peça= new Tipo1(especial);
           peça.addActionListener(new Gere_eventos_2(janela,array_peças,lado,score,peça,ronda,score_peça,c));
           peça.setText("NOVA!");
           return peça;
        }
        if(tipo==2){
   ...
   public void init_listeners(){
        ...
        for(i=0;i<lado;i++){
            for(j=0;j<lado;j++){
                array_peças[i][j].addActionListener(new Gere_eventos_2(janela,array_peças,lado,score,array_peças[i][j],ronda,score_peça,c));
            }
        }
    }
