 ...
 * 
 */
@WebService(name = "InsulinDoseCalculatorImp", targetNamespace = "http://server/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface InsulinDoseCalculatorImp {
    ...
    @Action(input = "http://server/InsulinDoseCalculatorImp/personalSensitivityToInsulinRequest", output = "http://server/InsulinDoseCalculatorImp/personalSensitivityToInsulinResponse")
    ...
    @Action(input = "http://server/InsulinDoseCalculatorImp/backgroundInsulinDoseRequest", output = "http://server/InsulinDoseCalculatorImp/backgroundInsulinDoseResponse")
    ...
    @Action(input = "http://server/InsulinDoseCalculatorImp/mealtimeInsulinDoseRequest", output = "http://server/InsulinDoseCalculatorImp/mealtimeInsulinDoseResponse")
