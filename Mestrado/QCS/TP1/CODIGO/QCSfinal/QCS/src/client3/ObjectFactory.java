...
public class ObjectFactory {
    ...
    private final static QName _PersonalSensitivityToInsulinResponse_QNAME = new QName("http://server/", "personalSensitivityToInsulinResponse3");
    private final static QName _BackgroundInsulinDose_QNAME = new QName("http://server/", "backgroundInsulinDose3");
    private final static QName _BackgroundInsulinDoseResponse_QNAME = new QName("http://server/", "backgroundInsulinDoseResponse3");
    private final static QName _MealtimeInsulinDose_QNAME = new QName("http://server/", "mealtimeInsulinDos3e");
    private final static QName _MealtimeInsulinDoseResponse_QNAME = new QName("http://server/", "mealtimeInsulinDoseResponse3");
    private final static QName _PersonalSensitivityToInsulin_QNAME = new QName("http://server/", "personalSensitivityToInsulin3");
