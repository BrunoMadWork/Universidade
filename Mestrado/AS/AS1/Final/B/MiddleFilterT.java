...
public class MiddleFilterT extends FilterFramework
{
	public void run()
    {
		/************************************************************************************
		...
		while (true)
		{
			try
			{
				...
				****************************************************************************/
				...
				if ( id == 4 )
				{
					Double measurementAux=  ConverterToCelsius(Double.longBitsToDouble(measurement)) ; // TEM DE SE PASSAR PARA FLOAT ACHO EU
   ...
   Double ConverterToCelsius( Double temperatureFa) {
